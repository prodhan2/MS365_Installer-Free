...
Public Class Main
    ...
    Private Sub LinkLabel_DeveloperProfile_LinkClicked(sender As Object, e As LinkLabelLinkClickedEventArgs) Handles LinkLabel_DeveloperProfile.LinkClicked
        ' Open developer profile in the default browser
        TryStartProcess("https://sujanpro.web.app")
    End Sub
